class Room {
	constructor(rows, cols, seatsFilled) {
...
var temp = [{"r":2,"c":3, "ar":{1:{2:1}},"rn":"1A"},{"r":4,"c":7, "ar":{3:{1:1,4:1},2:{5:1,6:1}},"rn":"2B"}];
// Add room objects in parent object 
temp.forEach(function(item, index){
	roomsObj[item.rn] = new Room(item.r,item.c, item.ar);
});
